...
# This can be downloaded executing: ./get_source.sh
Source0:       mISDNuser-%{commit}.tar.gz
...
%changelog
* Wed Feb 03 2016 Huaren Zhong <huaren.zhong@gmail.com> 2.0.19
- Rebuild for Fedora
